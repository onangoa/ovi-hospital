            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a class="btn btn-primary" target="_blank" href="{{ route('prescriptions.index') }}?export=1">
                            <i class="fas fa-cloud-download-alt"></i> @lang('Export')
                        </a>
                        <a class="btn btn-danger" target="_blank" href="{{ route('prescriptions.index') }}?export_pdf=1">
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            @can('prescription-update')
                                                <a href="{{ route('prescriptions.edit', $prescription) }}?user_id={{ $prescription->user_id }}" class="btn btn-success btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit ambitious-padding-btn"></i></a>
                                            @endcan
                                            @can('prescription-delete')
                                                <a href="#" data-href="{{ route('prescriptions.destroy', $prescription) }}" class="btn btn-danger btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash ambitious-padding-btn"></i></a>
                                            @endcan
                                        </div>
                                    </td>
                                </tr>
