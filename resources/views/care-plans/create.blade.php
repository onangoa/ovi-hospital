            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('Add Care Plan')</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">@lang('Add Care Plan')</h3>
                </div>
                <div class="card-body">
                    <form id="carePlanForm" class="form-material form-horizontal" action="{{ route('care-plans.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="card card-primary mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="dietary_needs" class="form-control @error('dietary_needs') is-invalid @enderror" id="dietary_needs" rows="2">{{ old('dietary_needs') }}</textarea>
                                        @error('dietary_needs')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>
                                    <div class="mb-3">
                                        <label for="activity_restrictions" class="form-label">@lang('Activity Restrictions')</label>
                                        <textarea name="activity_restrictions" class="form-control @error('activity_restrictions') is-invalid @enderror" id="activity_restrictions" rows="2">{{ old('activity_restrictions') }}</textarea>
                                        @error('activity_restrictions')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>
                                    <div class="mb-3">
                                        <label for="wound_care" class="form-label">@lang('Wound or Skin Care')</label>
                                        <textarea name="wound_care" class="form-control @error('wound_care') is-invalid @enderror" id="wound_care" rows="2">{{ old('wound_care') }}</textarea>
                                        @error('wound_care')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="admission_decision" id="outpatient" value="outpatient" {{ old('admission_decision') == 'outpatient' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="outpatient">@lang('Outpatient Services')</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="admission_decision" id="inpatient" value="inpatient" {{ old('admission_decision') == 'inpatient' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="inpatient">@lang('Inpatient Admission')</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="admission_decision" id="longTermCare" value="longTermCare" {{ old('admission_decision') == 'longTermCare' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="longTermCare">@lang('Long-term Care Admission')</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="tests_needed" id="testsNeededYes" value="yes" {{ old('tests_needed') == 'yes' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="testsNeededYes">@lang('Yes')</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="tests_needed" id="testsNeededNo" value="no" {{ old('tests_needed') == 'no' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="testsNeededNo">@lang('No')</label>
                                        </div>
                                        <textarea name="tests_comments" class="form-control mt-2 @error('tests_comments') is-invalid @enderror" id="tests_comments" rows="2" placeholder="@lang('Comments on additional tests or referrals')">{{ old('tests_comments') }}</textarea>
                                        @error('tests_comments')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                @error('provider_signature')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                            </div>
                                        </div>
                                    </div>
                        </div>
