...
class RoleController extends Controller
{
    ...
    public function update(Request $request, Role $role)
    {
        ...
        if ($role->name === 'Super Admin') {
            return redirect()->route('roles.index')->with('error', trans('Super Admin role cannot be edited for security reasons.'));
        }
    ...
    public function destroy(Role $role)
    {
        ...
        if ($role->name === 'Super Admin') {
            return redirect()->route('roles.index')->with('error', trans('Super Admin role cannot be deleted for security reasons.'));
        }
