            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('Add Ward')</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">@lang('Add Ward')</h3>
                </div>
                <div class="card-body">
                    <form class="form-material" method="POST" action="{{ route('wards.store') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="capacity" value="{{ old('capacity', 0) }}" min="0">
                            @error('capacity')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
