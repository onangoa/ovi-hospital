...
@section('title', __('Add Vital Sign'))
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ __('Add New Vital Sign') }}</h3>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @enderror
                                            <small class="form-text text-muted">{{ __('Unique identifier for the field (no spaces, use underscores)') }}</small>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('field_type') is-invalid @enderror" 
                                                ...
                                                <option value="text" {{ old('field_type') == 'text' ? 'selected' : '' }}>{{ __('Text') }}</option>
                                                <option value="number" {{ old('field_type') == 'number' ? 'selected' : '' }}>{{ __('Number') }}</option>
                                                <option value="select" {{ old('field_type') == 'select' ? 'selected' : '' }}>{{ __('Select/Dropdown') }}</option>
                                            </select>
                                            @error('field_type')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('category') is-invalid @enderror" 
                                                   id="category" name="category" value="{{ old('category', 'general') }}" 
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('field_options') is-invalid @enderror" 
                                                      ...
                                                      placeholder="{{ __('Enter options as key:value pairs, one per line') }}">{{ old('field_options') }}</textarea>
