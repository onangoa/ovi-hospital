...
use App\Exports\PrescriptionPdfExport;
use App\Exports\PrescriptionsPdfExport;
...
class PrescriptionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return view('prescriptions._index', compact('prescriptions'));
        }
    ...
    {
        return Excel::download(new PrescriptionExport($request), 'Prescriptions.xlsx');
    }
    ...
    {
        $pdfExport = new PrescriptionsPdfExport($request);
    ...
    public function store(Request $request)
    {
        ...
        $prescriptionData = $request->only(['user_id', 'chief_complaint', 'note', 'prescription_date']);
    ...
    {
        if (request()->export_pdf) {
            return $this->exportPrescriptionPdf($prescription);
        }
    ...
    {
        $pdfExport = new PrescriptionPdfExport($prescription);
        return $pdfExport->download();
    }
}
