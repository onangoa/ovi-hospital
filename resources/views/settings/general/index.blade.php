                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group input-group mb-3">
                                                    ...
                                                    <input type="text" name="company_name" class="form-control @error('company_name') is-invalid @enderror" placeholder="@lang('Enter Hospital Name')" value="{{ old('company_name',$company->company_name) }}" required>
                                                    @error('company_name')
