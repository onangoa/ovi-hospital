            ...
            <div class="card-body">
                <form id="userQuickForm" class="form-material form-horizontal" action="{{ route('users.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-md-12 col-form-label"><h4>@lang('External ID')</h4></label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-id-card"></i></span>
                                    </div>
                                    <input class="form-control ambitious-form-loading @error('external_id') is-invalid @enderror" name="external_id" value="{{ old('external_id') }}" id="external_id" type="text" placeholder="@lang('Type External ID Here')">
                                    @error('external_id')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-md-12 col-form-label"><h4>@lang('Shifts')</h4></label>
                                <div class="col-md-12">
                                    <select class="select2 custom-width-100 @error('shifts') is-invalid @enderror" id="shifts" name="shifts[]" multiple="multiple" data-placeholder="@lang('Select shifts')">
                                        @foreach($shifts as $shift)
                                            <option value="{{ $shift->id }}" @if(is_array(old('shifts')) && in_array($shift->id, old('shifts'))) selected @endif>{{ $shift->name }} ({{ $shift->time_range }})</option>
                                        @endforeach
                                    </select>
                                    @error('shifts')
                                        <div class="invalid-feedback">
