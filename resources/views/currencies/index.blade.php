                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    @can('currencies-update')
                                        <a href="{{ route('currency.edit', $currency) }}" class="btn btn-success btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit ambitious-padding-btn"></i></a>
                                    @endcan
                                    @can('currencies-delete')
                                        <a href="#" data-href="{{ route('currency.destroy', $currency) }}" class="btn btn-danger btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash ambitious-padding-btn"></i></a>
                                    @endcan
                                </div>
                            </td>
                        </tr>
