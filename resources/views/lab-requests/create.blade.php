            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('Add Lab Request')</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">@lang('Add Lab Request')</h3>
                </div>
                <div class="card-body">
                    <form class="form-material form-horizontal" action="{{ route('lab-requests.store') }}" method="POST">
                        @csrf
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea name="specimen" id="specimen" class="form-control @error('specimen') is-invalid @enderror" rows="3" placeholder="@lang('Specimen Details')">{{ old('specimen') }}</textarea>
                                                @error('specimen')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="blood_bank" id="bloodBank" value="1" {{ old('blood_bank') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="bloodBank">@lang('Blood Bank')</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="histology" id="histology" value="1" {{ old('histology') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="histology">@lang('Histology/Cytology')</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="serology" id="serology" value="1" {{ old('serology') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="serology">@lang('Serology')</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="haematology" id="haematology" value="1" {{ old('haematology') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="haematology">@lang('Haematology')</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="bacteriology" id="bacteriology" value="1" {{ old('bacteriology') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="bacteriology">@lang('Bacteriology')</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="parasitology" id="parasitology" value="1" {{ old('parasitology') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="parasitology">@lang('Parasitology')</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="biochemistry" id="biochemistry" value="1" {{ old('biochemistry') ? 'checked' : '' }}>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea name="other_destination" id="other_destination" class="form-control @error('other_destination') is-invalid @enderror" rows="3" placeholder="@lang('Other')">{{ old('other_destination') }}</textarea>
                        ...
                        <div id="vital-signs-container">
                                <!-- Vital signs will be added here -->
                        </div>
                        ...
                        <div class="card mb-4 form-card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <textarea name="investigation_requested" class="form-control @error('investigation_requested') is-invalid @enderror" id="investigation_requested" rows="3" placeholder="@lang('Investigation Requested')">{{ old('investigation_requested') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="differential_diagnosis" class="form-control @error('differential_diagnosis') is-invalid @enderror" id="differential_diagnosis" rows="3" placeholder="@lang('Differential Diagnosis')">{{ old('differential_diagnosis') }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="clinician_name" id="clinician_name" class="form-control @error('clinician_name') is-invalid @enderror" placeholder="@lang('Name')" value="{{ Auth::user()->name }}" readonly>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="request_date" id="request_date" class="form-control @error('request_date') is-invalid @enderror" placeholder="@lang('Date')" value="{{ now()->toDateString() }}" readonly>
                                                @error('request_date')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
