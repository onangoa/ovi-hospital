            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    @can('prescription-update')
                        <a href="{{ route('prescriptions.edit', $prescription) }}?user_id={{ $prescription->user_id }}" class="btn btn-primary">@lang('Edit')</a>
                        <a href="{{ route('prescriptions.show', $prescription) }}?export_pdf=1" class="btn btn-danger" target="_blank">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <p>{{ $prescription->user->weight }}</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="height">@lang('Height (feet)')</label>
                                        <p>{{ $prescription->user->height }}</p>
                                    </div>
                                </div>
                            </div>
