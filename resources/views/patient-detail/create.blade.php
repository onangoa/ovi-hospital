                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" id="weight" name="weight" value="{{ old('weight') }}" class="form-control @error('weight') is-invalid @enderror" placeholder="@lang('Weight')" step="0.01">
                                    @error('weight')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" id="height" name="height" value="{{ old('height') }}" class="form-control @error('height') is-invalid @enderror" placeholder="@lang('Height')" step="0.01">
                                    @error('height')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <textarea name="likes" id="likes" class="form-control @error('likes') is-invalid @enderror" rows="3" placeholder="@lang('Likes')">{{ old('likes') }}</textarea>
                                    @error('likes')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <textarea name="dislikes" id="dislikes" class="form-control @error('dislikes') is-invalid @enderror" rows="3" placeholder="@lang('Dislikes')">{{ old('dislikes') }}</textarea>
                                    @error('dislikes')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <textarea name="care_preferences" id="care_preferences" class="form-control @error('care_preferences') is-invalid @enderror" rows="3" placeholder="@lang('Care Preferences')">{{ old('care_preferences') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <textarea name="info" id="info" class="form-control @error('info') is-invalid @enderror" rows="3" placeholder="@lang('Additional Info')">{{ old('info') }}</textarea>
                                    @error('info')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="guardian_name" name="guardian_name" value="{{ old('guardian_name') }}" class="form-control @error('guardian_name') is-invalid @enderror" placeholder="@lang('Guardian Name')">
                                    @error('guardian_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="guardian_phone" name="guardian_phone" value="{{ old('guardian_phone') }}" class="form-control @error('guardian_phone') is-invalid @enderror" placeholder="@lang('Guardian Phone')">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="email" id="guardian_email" name="guardian_email" value="{{ old('guardian_email') }}" class="form-control @error('guardian_email') is-invalid @enderror" placeholder="@lang('Guardian Email')">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="guardian_relation" name="guardian_relation" value="{{ old('guardian_relation') }}" class="form-control @error('guardian_relation') is-invalid @enderror" placeholder="@lang('Relation')">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <textarea name="guardian_address" id="guardian_address" class="form-control @error('guardian_address') is-invalid @enderror" rows="3" placeholder="@lang('Guardian Address')">{{ old('guardian_address') }}</textarea>
