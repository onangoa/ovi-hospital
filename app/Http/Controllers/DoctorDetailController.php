...
use App\Exports\DoctorDetailsExport;
use App\Exports\DoctorDetailsPdfExport;
use App\Exports\DoctorDetailPdfExport;
use App\Models\User;
...
class DoctorDetailController extends Controller
{
    ...
    {
        return Excel::download(new DoctorDetailsExport($request), 'DoctorDetails.xlsx');
    }
    ...
    {
        $pdfExport = new DoctorDetailsPdfExport($request);
    ...
    {
        if (request()->export_pdf) {
            return $this->exportDoctorDetailPdf($doctorDetail);
        }
    ...
    private function validation(Request $request, $id = 0)
    {
        ...
        /**
         * Export individual doctor detail to PDF
         *
         * @param DoctorDetail $doctorDetail
         * @return \Illuminate\Http\Response
         */
        private function exportDoctorDetailPdf(DoctorDetail $doctorDetail)
        {
            $pdfExport = new DoctorDetailPdfExport($doctorDetail);
            return $pdfExport->download();
        }
    }
