                                        ...
                                        <div class="btn-group" role="group">
                                            @can('role-update')
                                                @if($role->name === 'Super Admin')
                                                    <button class="btn btn-success btn-outline btn-circle btn-lg" disabled data-toggle="tooltip" title="@lang('Edit') - @lang('Super Admin role cannot be edited')"><i class="fa fa-edit ambitious-padding-btn"></i></button>
                                                @else
                                                    <a href="{{ route('roles.edit', $role) }}" class="btn btn-success btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit ambitious-padding-btn"></i></a>
                                                @endif
                                            @endcan
                                            @can('role-delete')
                                                @if($role->name === 'Super Admin')
                                                    <button class="btn btn-danger btn-outline btn-circle btn-lg" disabled data-toggle="tooltip" title="@lang('Delete') - @lang('Super Admin role cannot be deleted')"><i class="fa fa-trash ambitious-padding-btn"></i></button>
                                                @else
                                                    <a href="#" data-href="{{ route('roles.destroy', $role) }}" class="btn btn-danger btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash ambitious-padding-btn"></i></a>
                                                @endif
                                            @endcan
                                        </div>
                                    </td>
