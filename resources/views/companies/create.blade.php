            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">
                        <a href="{{ route('company.index') }}">{{ __('Hospital List') }}</a></li>
                    <li class="breadcrumb-item active">{{ __('Add Hospital') }}</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <form class="form-material form-horizontal" action="{{ route('company.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-md-12">
                                    <h4>{{ __('Hospital Email') }} <b class="ambitious-crimson">*</b></h4>
                                </label>
                                <div class="col-md-12">
                                    <input class="form-control ambitious-form-loading @error('company_email') is-invalid @enderror" name="company_email" value="{{ old('company_email') }}" id="company_email" type="email" placeholder="{{ __('Enter Hospital Email') }}" required>
                                    @error('company_email')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
