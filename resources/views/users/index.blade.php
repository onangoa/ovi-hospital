                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        @can('user-update')
                                            <a href="{{ route('users.edit', $user->id) }}" class="btn btn-success btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit ambitious-padding-btn"></i></a>
                                        @endcan
                                        @can('user-delete')
                                            <a href="#" data-href="{{ route('users.destroy', $user->id) }}" class="btn btn-danger btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash ambitious-padding-btn"></i></a>
                                        @endcan
                                    </div>
                                </td>
                            </tr>
