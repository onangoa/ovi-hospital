            ...
            <div class="card-body">
                <form id="labReportFrom" class="form-material form-horizontal" action="{{ route('lab-reports.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="date" id="date" class="form-control today-flatpickr generate_report_template @error('date') is-invalid @enderror" placeholder="@lang('Date')" value="{{ old('date', now()->format('Y-m-d')) }}" readonly required>
                                    @error('date')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="doctor_id">@lang('Conducted by') </label>
                                <input type="text" name="doctor_name" id="doctor_id" class="form-control @error('doctor_id') is-invalid @enderror" value="{{ Auth::user()->name }}" readonly>
