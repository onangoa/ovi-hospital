            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a class="btn btn-danger" target="_blank" href="{{ route('doctor-details.index') }}?export_pdf=1">
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            @can('doctor-detail-update')
                                                <a href="{{ route('doctor-details.edit', $doctorDetail) }}" class="btn btn-success btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit ambitious-padding-btn"></i></a>
                                            @endcan
                                            @can('doctor-detail-delete')
                                                <a href="#" data-href="{{ route('doctor-details.destroy', $doctorDetail) }}" class="btn btn-danger btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash ambitious-padding-btn"></i></a>
                                            @endcan
                                        </div>
                                    </td>
                                </tr>
