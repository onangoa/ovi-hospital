                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    @can('email-template-update')
                                        <a href="{{ route('email-templates.edit', $emailTemplate) }}" class="btn btn-success btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit ambitious-padding-btn"></i></a>
                                    @endcan
                                    @can('email-template-delete')
                                        <a href="#" data-href="{{ route('email-templates.destroy', $emailTemplate) }}" class="btn btn-danger btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash ambitious-padding-btn"></i></a>
                                    @endcan
                                </div>
                            </td>
                        </tr>
