...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header"><h3 class="card-title">@lang('Department List')</h3></div>
                <div class="card-body">
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            @can('hospital-department-update')
                                                <a href="{{ route('hospital-departments.edit', $hospitalDepartment) }}" class="btn btn-success btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit ambitious-padding-btn"></i></a>
                                            @endcan
                                            @can('hospital-department-delete')
                                                <a href="#" data-href="{{ route('hospital-departments.destroy', $hospitalDepartment) }}" class="btn btn-danger btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash ambitious-padding-btn"></i></a>
                                            @endcan
                                        </div>
                                    </td>
                                </tr>
