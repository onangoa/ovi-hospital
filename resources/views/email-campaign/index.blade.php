                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    @endif
                                    <a href="#" data-href="{{ route('email-campaigns.destroy', $emailCampaign) }}" class="btn btn-danger btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash ambitious-padding-btn"></i></a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
