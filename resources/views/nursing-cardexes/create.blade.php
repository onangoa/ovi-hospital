            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('Add Nursing Cardex')</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">@lang('Add Nursing Cardex')</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('nursing-cardexes.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="brief_report" id="brief_report" class="form-control @error('brief_report') is-invalid @enderror" rows="3">{{ old('brief_report') }}</textarea>
                                    @error('brief_report')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
