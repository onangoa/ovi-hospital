                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            @can('patient-case-studies-update')
                                                <a href="{{ route('patient-case-studies.edit', $patientDetail) }}" class="btn btn-success btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit ambitious-padding-btn"></i></a>
                                            @endcan
                                            @can('patient-case-studies-delete')
                                                <a href="#" data-href="{{ route('patient-case-studies.destroy', $patientDetail) }}" class="btn btn-danger btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash ambitious-padding-btn"></i></a>
                                            @endcan
                                        </div>
                                    </td>
                                </tr>
